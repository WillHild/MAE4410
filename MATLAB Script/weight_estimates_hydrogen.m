...
%     Cj = 0.4; %JetA
    ...
    % Loitering
%     Cj_loiter = 0.5; %JetA
  Cj_loiter = 0.211*(0.4/0.5); %assuming cj has same ratio for each fuel (cj_loiter,h2/cj_cruise,h2 = cj_loiter_jetA/cj_cruise_jetA)
    LD_loiter = 16;
    E_loiter = 0.5; % hr
...
fprintf('\n    Total Fuel Weight is: %12.4f kg',1.05*fuel_weight)
